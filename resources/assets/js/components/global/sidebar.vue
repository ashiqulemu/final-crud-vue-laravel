<template>
    <div>
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                <li>
                    <router-link class="app-menu__item active"  :to="{name:'createProduct'}">
                        <i class="app-menu__icon fa fa-dashboard"></i>
                        <span class="app-menu__label">Add Product</span>
                    </router-link>
                </li>
                <li>
                    <router-link class="app-menu__item active"  :to="{name:'viewProduct'}">
                        <i class="app-menu__icon fa fa-dashboard"></i>
                        <span class="app-menu__label">View Product</span>
                    </router-link>
                </li>
                <li class="treeview">
